...
const DICT = {
  ...
  "Otabek Sobitov ijtimoiy tarmoqlarda:": { ru: "Отабек Собитов в социальных сетях:", en: "Otabek Sobitov on social media:" },
  ...
  "Telegram sahifasini ochish ↗": { ru: "Открыть страницу Telegram ↗", en: "Open Telegram page ↗" },
  ...
  "Telegram sahifasidagi e'lonlar va yangiliklar bilan shu yerdan tanishishingiz mumkin.": {
    ru: "Здесь вы можете ознакомиться с объявлениями и новостями в Telegram.",
    en: "Here you can follow announcements and news from the Telegram channel.",
  },
  ...
  "Batafsil": { ru: "Подробнее", en: "Details" },
  "Aloqa uchun": { ru: "Контакты", en: "Contact" },
